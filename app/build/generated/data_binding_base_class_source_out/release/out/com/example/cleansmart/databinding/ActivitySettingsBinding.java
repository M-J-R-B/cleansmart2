...
public final class ActivitySettingsBinding implements ViewBinding {
  ...
  @NonNull
  public final LinearLayout listViewDemoLayout;
  ...
  public static ActivitySettingsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.listViewDemoLayout;
      LinearLayout listViewDemoLayout = ViewBindings.findChildViewById(rootView, id);
      if (listViewDemoLayout == null) {
        break missingId;
      }
