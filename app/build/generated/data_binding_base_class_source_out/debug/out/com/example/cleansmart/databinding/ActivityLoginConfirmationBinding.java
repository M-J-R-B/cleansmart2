...
public final class ActivityLoginConfirmationBinding implements ViewBinding {
  ...
  private ActivityLoginConfirmationBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull LinearLayout logoutLayout, @NonNull ConstraintLayout main,
  ...
  @NonNull
  public static ActivityLoginConfirmationBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityLoginConfirmationBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_login_confirmation, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityLoginConfirmationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginConfirmationBinding((ConstraintLayout) rootView, aboutLayout,
          accountLayout, backButton, darkModeLayout, inviteLayout, languageLayout, logoutLayout,
          main, notificationsLayout, privacyLayout, securityLayout, termsLayout, toolbar);
    }
